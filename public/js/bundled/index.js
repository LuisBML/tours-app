...
})({"gTVKZ":[function(require,module,exports) {
...
var _updateUserDataJs = require("./updateUserData.js");
var _stripePaymentJs = require("./stripePayment.js");
// DOM ELEMENTS
...
if (myMap) {
    ...
    (0, _mapboxJs.displayMap)(allLocations);
}
if (loginForm) loginForm.addEventListener("submit", (e)=>{
    e.preventDefault();
    const userEmail = document.getElementById("email").value;
    const userPassword = document.getElementById("password").value;
    (0, _loginJs.login)(userEmail, userPassword);
});
if (registerForm) registerForm.addEventListener("submit", (e)=>{
    ...
    (0, _registerJs.register)(userName, userEmail, userPassword, userPasswordConfirm);
});
...
if (userDataForm) userDataForm.addEventListener("submit", async (e)=>{
    ...
    await (0, _updateUserDataJs.updateSettings)(form, "data");
...
if (userPasswordForm) userPasswordForm.addEventListener("submit", async (e)=>{
    ...
    await (0, _updateUserDataJs.updateSettings)({
        currentPassword: currentUserPassword,
        newPassword: newUserPassword,
        passwordConfirm: confirmUserPassword
    }, "password");
...
if (bookBtn) bookBtn.addEventListener("click", async (e)=>{
    try {
        ...
        await (0, _stripePaymentJs.bookTour)(id);
...
},{"./login.js":"7yHem","./mapbox.js":"3zDlz","./updateUserData.js":"hFIIY","./stripePayment.js":"iMlVz","./register.js":"eBq2z"}],"7yHem":[function(require,module,exports) {
...
const logout = async function() {
    ...
    try {
        ...
        if (res.data.status === "success") // reload page; 'true' argument forces a reload from the server
...
const hideAlert = ()=>{
    ...
    if (elementAlert) elementAlert.parentElement.removeChild(elementAlert);
};
...
const displayMap = (tourLocations)=>{
    ...
    for (const tourLocation of tourLocations){
        new maptilersdk.Marker().setLngLat(tourLocation.coordinates).addTo(map);
        new maptilersdk.Popup({
            offset: 30,
            closeOnClick: false,
            closeButton: false
        }).setLngLat(tourLocation.coordinates).setHTML(`<p><strong>Day ${tourLocation.day}</strong>: ${tourLocation.description}</p>`).addTo(map);
    }
};
...
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _alerts = require("./alerts");
const updateSettings = async function(userData, type) {
    // Axios is a promise-based HTTP Client for node.js and the browser
    try {
        const usersUrl = type === "password" ? "http://localhost:3000/api/v1/users/update-password" : "http://localhost:3000/api/v1/users/update-me";
        const res = await (0, _axiosDefault.default)({
            method: "PATCH",
            url: usersUrl,
            data: userData
...
},{"axios":"jo6P5","./alerts":"6Mcnf","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"iMlVz":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const bookTour = async (tourId)=>{
    try {
        ...
        const res = await (0, _axiosDefault.default)(`http://localhost:3000/api/v1/bookings/checkout-session/${tourId}`);
        // 2. Create checkout form + charge credit card
        if (res.status === 200) // The assign() method of the Location interface causes the window to load and display the document at the URL specified. After the navigation occurs, the user can navigate back to the page that called Location.assign() by pressing the "back" button. - mdn
        location.assign(res.data.session.url);
    } catch (error) {
        console.log(error);
        (0, _alerts.showAlert)("error", "An error ocurred while processing the payment. Please try again later.");
    }
};

},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./alerts":"6Mcnf"}],"eBq2z":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"axios":"jo6P5","./alerts":"6Mcnf","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["gTVKZ","f2QDv"], "f2QDv", "parcelRequire11c7")
